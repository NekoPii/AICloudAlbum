...
class LoginForm(forms.Form):
    ...
    pwd = forms.CharField(widget=forms.PasswordInput(attrs={"class": "form-control-input", "id": "login_pwd", "tabindex": "2"}))
...
class SignupForm(forms.Form):
    ...
    name = forms.CharField(
        widget=forms.TextInput(attrs={"class": "form-control-input", "id": "signup_name", "tabindex": "2"}))
    pwd = forms.CharField(
        widget=forms.PasswordInput(attrs={"class": "form-control-input", "id": "signup_pwd", "tabindex": "3"}))
    re_pwd = forms.CharField(
        widget=forms.PasswordInput(attrs={"class": "form-control-input", "id": "re_signup_pwd", "tabindex": "4"}))
    def clean_phone(self):
        phone=self.cleaned_data["phone"]
        pattern=re.compile(r"^(1[3-9][0-9]{9})")
        if pattern.match(phone):
